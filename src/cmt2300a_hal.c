...
void CMT2300A_InitGpio(void)
{
    ...
    cmt_port_init(PKG_RFM300_SPI_DEV_NAME,
                  PKG_RFM300_FIFO_SPI_DEV_NAME,
                  PKG_RFM300_SPI_BUS_NAME,
                  PKG_RFM300_CSB_PIN,
                  PKG_RFM300_FCSB_PIN);
}
