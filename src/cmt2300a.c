...
* @param   bEnable(RT_TRUE): active-high (default)
*          bEnable(RT_FALSE): active-low
* *********************************************************/
...
* @param   bEnable(RT_TRUE): Enable it(default)
*          bEnable(RT_FALSE): Disable it
* *********************************************************/
...
* @param   bEnable(RT_TRUE): use a single 64-byte FIFO for either Tx or Rx
*          bEnable(RT_FALSE): use a 32-byte FIFO for Tx and another 32-byte FIFO for Rx(default)
* *********************************************************/
...
*          call CMT2300A_EnableTxDin(RT_TRUE) in the direct mode.
* @param   nDinSel
...
* @param   bEnable(RT_TRUE): used as DIN
*          bEnable(RT_FALSE): used as DOUT(default)
* *********************************************************/
...
* @param   bEnable(RT_TRUE): invert DIN
*          bEnable(RT_FALSE): not invert DIN(default)
* *********************************************************/
...
* @desc    Chip indentify.
* @return  RT_TRUE: chip is exist, RT_FALSE: chip not found
* *********************************************************/
...
* @param   bEnable(RT_TRUE): Enable it
*          bEnable(RT_FALSE): Disable it(default)
* *********************************************************/
...
void CMT2300A_Init(void)
{
    ...
    CMT2300A_EnableLfosc(RT_FALSE);             /* Diable LFOSC */
