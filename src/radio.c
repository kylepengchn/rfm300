...
static uint32_t g_nRxTimeout = 0xFFFFFFFF;
static uint32_t g_nTxTimeout = 0xFFFFFFFF;
...
EnumRFResult RF_Process(void)
{
    ...
    case RF_STATE_RX_WAIT:
    {
        ...
        if( (0xFFFFFFFF != g_nRxTimeout) && ((CMT2300A_GetTickCount()-g_nRxTimeCount) > g_nRxTimeout) )
    ...
    case RF_STATE_TX_WAIT:
    {
        ...
        if( (0xFFFFFFFF != g_nTxTimeout) && ((CMT2300A_GetTickCount()-g_nTxTimeCount) > g_nTxTimeout) )
